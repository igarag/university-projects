...
def validation(gt_path, thresh_img):
    ...
    cv2.imwrite('./validation/' + image[0] + '_validation.png', thresh_img_color) 
...
if __name__== "__main__":
    ...
    validation_images = [
        ...
        ['./austin10.tif', './austin10_gt.tif'],
        ['./tyrol-w1.tif', './tyrol-w1_gt.tif']
    ]
    ...
    for image in validation_images:
        ...
        _, _, _, thresh_img = build_detector.buildDetector('./validation/' + image[0])
